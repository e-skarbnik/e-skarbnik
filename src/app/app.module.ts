...
import { EventEditComponent } from './navbar/events/event-edit/event-edit.component';
...
@NgModule({
  ...
  providers: [AuthService, MemberService, AuthGuardService, ClassCrudService, EventCrudService],
